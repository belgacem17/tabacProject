...
GO
PRINT N'Création de Clé étrangère [dbo].[FKhh_News_Users]...';


GO
ALTER TABLE [dbo].[News] WITH NOCHECK
    ADD CONSTRAINT [FKhh_News_Users] FOREIGN KEY ([UserId]) REFERENCES [dbo].[Users] ([UserId]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[News] WITH CHECK CHECK CONSTRAINT [FKhh_News_Users];
