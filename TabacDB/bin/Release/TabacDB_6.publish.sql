...
GO
PRINT N'Suppression de Clé étrangère [dbo].[FK_News_Users]...';
...
GO
PRINT N'Suppression de Clé étrangère [dbo].[FK_Reclamations_Commantaire]...';


GO
ALTER TABLE [dbo].[Reclamation] DROP CONSTRAINT [FK_Reclamations_Commantaire];


GO
PRINT N'Suppression de Clé étrangère [dbo].[FK_Reclamations_Users]...';


GO
ALTER TABLE [dbo].[Reclamation] DROP CONSTRAINT [FK_Reclamations_Users];
...
ALTER TABLE [dbo].[News] WITH NOCHECK
    ADD CONSTRAINT [FK_News_Users] FOREIGN KEY ([UserId]) REFERENCES [dbo].[Users] ([UserId]) ON DELETE CASCADE;
